...
export default function DocumentsError({ error, reset }: Props) {
  useEffect(() => { captureException(error, { action: 'DocumentsError' }) }, [error])
  return (
    <div className="p-8 max-w-xl mx-auto mt-12">
      <div className="bg-red-950 border border-red-800 rounded-xl p-6 text-center space-y-3">
        ...
        <p className="text-red-300 font-medium">Error al cargar documentos</p>
        <p className="text-red-400 text-sm">No se pudo completar la operación. Intente nuevamente.</p>
